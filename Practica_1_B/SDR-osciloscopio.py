...
class SDR-osciloscopio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "SDR-osciloscopio")
        ...
        self.uhd_usrp_sink_0.set_center_freq(50M, 0)
        self.uhd_usrp_sink_0.set_antenna("TX/RX", 0)
        self.uhd_usrp_sink_0.set_gain(0, 0)
        self._fc_range = Range(50M, 2.2G, 1M, 50M, 200)
        ...
        self._A_range = Range(0, 1, 100u, 500m, 200)
...
def main(top_block_cls=SDR-osciloscopio, options=None):
