...
class SDRosciloscopio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "SDRosciloscopio")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 25e6/64
        self.fc = fc = 50000000
        self.GTX = GTX = 30
        self.A = A = 0.5
        ...
        # Blocks
        ##################################################
        self._fc_range = Range(50000000, 2.2e9, 1000000, 50000000, 200)
        ...
        self._A_range = Range(0, 1, 0.001, 0.5, 200)
...
def main(top_block_cls=SDRosciloscopio, options=None):
