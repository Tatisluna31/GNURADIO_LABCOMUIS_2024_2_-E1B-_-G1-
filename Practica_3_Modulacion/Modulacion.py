...
class Modulacion(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, Ac=1, Ka=1):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Modulacion")
        ...
        self.blocks_multiply_const_vxx_2 = blocks.multiply_const_cc(Ac)
        ...
        self.connect((self.blocks_multiply_const_vxx_2, 0), (self, 0))
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.blocks_multiply_const_vxx_2.set_k(self.Ac)
...
def argument_parser():
    ...
    parser.add_argument(
        ...
        help="Set Amplitud de la portadora [default=%(default)r]")
    parser.add_argument(
