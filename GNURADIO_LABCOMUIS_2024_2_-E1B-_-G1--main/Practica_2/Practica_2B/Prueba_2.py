...
class Prueba_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Prueba_2")
        ...
        self._t_band_range = qtgui.Range(0, samp_rate/200, 100, samp_rate/200, 200)
...
def main(top_block_cls=Prueba_2, options=None):
