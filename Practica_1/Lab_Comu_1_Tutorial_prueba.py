...
class Lab_Comu_1_Tutorial_prueba(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_Comu_1_Tutorial_prueba")
        ...
        self._A_range = Range(-5, 5, 0.1, 1, 200)
        self._A_win = RangeWidget(self._A_range, self.set_A, "ampluitud", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, frequency, A, 0, 0)
...
def main(top_block_cls=Lab_Comu_1_Tutorial_prueba, options=None):
