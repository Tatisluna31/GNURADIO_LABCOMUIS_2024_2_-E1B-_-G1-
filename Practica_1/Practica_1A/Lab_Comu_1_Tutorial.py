...
# Title: Diagrama_1
# Author: Meyer_Suarez_Tatiana_Zarate_E1B_G1
...
class Lab_Comu_1_Tutorial(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Diagrama_1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Diagrama_1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_Comu_1_Tutorial")
...
def main(top_block_cls=Lab_Comu_1_Tutorial, options=None):
